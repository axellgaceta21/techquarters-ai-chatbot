...
export default function Footer() {
  return <footer className="footer"><div className="footer-glow"/><div className="container footer-grid">
    ...
    <div><h3>Connect</h3><a href="#linkedin">LinkedIn</a><a href="#instagram">Instagram</a><a href="#x">X / Twitter</a></div>
  </div><div className="container footer-bottom"><span>© {new Date().getFullYear()} TechQuarters AI</span><span>Built for intelligent growth.</span></div></footer>;
}
