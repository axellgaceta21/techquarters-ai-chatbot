...
export type IconName = "arrow" | "spark" | "agent" | "code" | "link" | "growth" | "megaphone" | "chat" | "check" | "menu" | "close" | "send" | "minus" | "plus" | "calendar";
export default function Icon({ name, ...props }: SVGProps<SVGSVGElement> & { name: IconName }) {
  const paths: Record<IconName, ReactNode> = {
    ...
    check: <path d="m5 12 4 4L19 6"/>, menu: <path d="M4 7h16M4 12h16M4 17h16"/>, close: <path d="m6 6 12 12M18 6 6 18"/>, send: <><path d="m22 2-7 20-4-9-9-4Z"/><path d="M22 2 11 13"/></>, minus: <path d="M5 12h14"/>, plus: <path d="M5 12h14M12 5v14"/>, calendar: <><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M16 3v4M8 3v4M3 10h18"/></>,
  };
